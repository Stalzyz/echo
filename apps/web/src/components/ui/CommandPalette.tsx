      ...
      >
        <div className="flex items-center px-4 border-b border-border/50">
          ...
          <input
            ...
            placeholder="Search Echo LMS... (e.g. Courses, Students, Analytics)"
        ...
        <div className="p-3 border-t border-border/50 bg-muted/20 flex items-center justify-between text-xs text-muted-foreground">
          ...
          <span className="font-bold flex items-center gap-1"><Search className="w-3 h-3 text-primary" /> Echo LMS Navigation</span>
        </div>
      </div>
    </div>
  )
