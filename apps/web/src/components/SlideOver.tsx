...
export function SlideOver({ open, onClose, title, subtitle, children }: SlideOverProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end md:items-stretch justify-end">
      ...
      {/* Panel */}
      <div className="relative w-full max-w-md h-[90vh] md:h-full bg-white border-t md:border-t-0 md:border-l border-slate-200 shadow-2xl flex flex-col animate-in slide-in-from-bottom md:slide-in-from-right duration-300 rounded-t-[2rem] md:rounded-none text-slate-900">
        {/* Header */}
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6 text-slate-900 custom-scrollbar">
          {children}
        </div>
      </div>
    </div>
