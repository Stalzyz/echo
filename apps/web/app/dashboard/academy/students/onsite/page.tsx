...
export default function StudentDirectory() {
  ...
  const handleEnrollSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Campus student enrolled successfully!")
  ...
  const handleDeleteStudent = async (studentId: string, studentName: string) => {
    if (!confirm(`Are you sure you want to remove ${studentName}? This action will revoke student enrollment access.`)) {
      return
    }
    try {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1 font-medium">Manage and edit physical campus enrollments</p>
            </div>
          </div>
