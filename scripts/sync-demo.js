...
async function main() {
  ...
  const passwordHash = await bcrypt.hash("echo123", 10);
  ...
  console.log("Database Sync Complete: Echo Academy (demo.academy@echo.in), Student (demo.student@echo.in), and Educator (demo.educator@echo.in) ready with password 'echo123'!");
}
